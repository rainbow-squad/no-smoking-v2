...
export const dialogsRu: MultilineContent = {
  ...
  // `,
  [Content.IDLE_NO_CIGARETTES]: `
    🪬 ${B}БОЛЬШАЯ ПАУЗА${B} 🪬${N2}
    Вы достигли интервала, когда без вас мы не можем понять, вы спали, или у вас такая большая пауза.${N2}
    Нам нужна ваша помощь!${N2}
    - ${B}Начать новый день${B} - если вы спали.${NL}
    - ${B}Продолжить${B} - если это просто большая пауза.${NL}
  `,
